...
T0 = 0.0014; % [day^-1] standard metabolic rate of fish at 15 degrees
Topt = 18;
...
eps = 4; % [degC] try, temperature at which MS = 0
a = 0.06;
Km = 30;
...
aM = @(temp) -0.33*K(temp); % [/kPa] coefficient for the dependency in O2 -  decrease aM increases tolerance to hypoxia, i.e. decreases pcrit
bM = @(temp) 0.8;%0.28;  % [-]
